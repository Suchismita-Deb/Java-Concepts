package com.learn.a3_javaLanguage.L7optional;
...
public class OpgtionalExamples {
    public static void main(String[] args) {
        ...
        //OrElseThrow
        //String ret4 = emptyStringOptional.orElseThrow(() -> new NullPointerException());//No such element exception
